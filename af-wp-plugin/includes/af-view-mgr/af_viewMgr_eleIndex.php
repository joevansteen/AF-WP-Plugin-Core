<?php
/*
 * af_viewMgr_eleIndex script Copyright (c) 2008 Architected Futures, LLC
 *
 * V1.8 2008-APR-15 JVS Bootstrap from af_dialogencode
 * V5   2019-APR-04 JVS EATSv5 required script include segment
 */

// Insure a correct execution context ...
require(AF_AUTOMATED_SCRIPTS.'/af_viewMgr_base.php');
$myProcClass = 'C_ViewMgrEleIndex';
...
class C_ViewMgrEleIndex extends C_ViewMgrBase {
...
//			$this->anchor->putTraceData(__LINE__, __FILE__, __CLASS__ . '::' . __FUNCTION__ . " Collection has $collectionSize items");
			for ($i = 0; $i < $collectionSize; $i++)
				...
				$listItem['ItemGuid'] 	= $collectionItemNode->getChildContentByName('OldKey');

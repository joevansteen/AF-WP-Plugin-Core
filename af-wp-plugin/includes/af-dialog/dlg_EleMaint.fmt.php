<?php
/*
 * dlg_EleMaint.fmt script Copyright (c) 2005 Architected Futures, LLC
 *
 * V1.3 2005-OCT-29 JVS Integration with new standalone PHP environment scripts.
 *								This is a replacement for tiki-air_EleMaint.tpl and
 *								was bootstrapped from airEleList.fmt
 * V1.7 2008-MAR-03 JVS Code conversion to PHPv5.2
 * V5   2019-APR-04 JVS EATSv5 required script include segment
 */

// Insure a correct execution context ...
$myProcClass = 'C_AirEleMaintPanel';
$myDynamClass = $myProcClass;	
require(AF_AUTOMATED_SCRIPTS.'/af_script_header.php');


class C_AirEleMaintPanel extends C_HtmlPanel {
	/***************************************************************************
	 * Constructor
	 *

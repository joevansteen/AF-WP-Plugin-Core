<?php
/*
 * dlg_Help.fmt script Copyright (c) 2005 Architected Futures, LLC
 *
...
$myProcClass = 'C_AirHelpPanel';
$myDynamClass = $myProcClass;	
require(AF_AUTOMATED_SCRIPTS.'/af_script_header.php');

class C_AirHelpPanel extends C_HtmlPanel {
	/***************************************************************************
	 * Constructor
	 *
 ...
 *************************************************************/
		...
		$myTitleData->initialize(htmlEleH1, null, 'Using the Help Facilities');

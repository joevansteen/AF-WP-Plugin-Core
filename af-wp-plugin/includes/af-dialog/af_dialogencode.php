<?php
/*
 * af_dialogencode script Copyright (c) 2005 Architected Futures, LLC
 *
...
//		$this->anchor->setDlgVar('panelItemTitle',	 'Model Element Maintenance');
		...
		$this->procContext->putSessionData('responseDialog', Dialog_EleMaint);
		}
...
//	   	else
		...
		$this->procContext->putSessionData('responseDialog', Dialog_EleList);
		}

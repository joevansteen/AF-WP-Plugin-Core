<?php
/*
 * dlg_Content.fmt script Copyright (c) 2005 Architected Futures, LLC
 *
...
$myProcClass = 'C_AirContentPanel';
$myDynamClass = $myProcClass;	
require(AF_AUTOMATED_SCRIPTS.'/af_script_header.php');

class C_AirContentPanel extends C_HtmlPanel {
	/***************************************************************************
	 * Constructor
	 *
...
//		$this->setHiddenElement('dlgAuth',			$this->anchor->sessionDoc->getAuthId());
		...
		$myTitleData->initialize(htmlEleH1, null, 'Content');

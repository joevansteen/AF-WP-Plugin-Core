<?php
/*
 * dlg_FileEdit.fmt script Copyright (c) 2005 Architected Futures, LLC
 *
...
$myProcClass = 'C_AirFileEditPanel';
$myDynamClass = $myProcClass;	
require(AF_AUTOMATED_SCRIPTS.'/af_script_header.php');

class C_AirFileEditPanel extends C_HtmlPanel {
	/***************************************************************************
	 * Constructor
	 *
...
//		$this->setHiddenElement('dlgPanelType',	$dlgPanelType);
		...
		$this->pageTitle = 'Element Edit';

		$myTitleData = new C_AirHtmlElement($this);
		$myTitleData->initialize(htmlEleH1, null, 'Element Edit');

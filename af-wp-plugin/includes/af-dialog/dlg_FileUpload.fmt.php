<?php
/*
 * dlg_FileUpload.fmt script Copyright (c) 2005 Architected Futures, LLC
 *
...
$myProcClass = 'C_AirFileUploadPanel';
$myDynamClass = $myProcClass;	
require(AF_AUTOMATED_SCRIPTS.'/af_script_header.php');

class C_AirFileUploadPanel extends C_HtmlPanel {
	/***************************************************************************
	 * Constructor
	 *
...
//		$this->setHiddenElement('dlgAuth',			$this->anchor->sessionDoc->getAuthId());
		...
		$this->pageTitle = 'Element Upload';

		$myTitleData = new C_AirHtmlElement($this);
		$myTitleData->initialize(htmlEleH1, null, 'Element Upload');
...
/***************************************
		...
		***********************************/
		...
		$work				= & $pageBody->createChild(htmlEleTextarea, $fileContent);

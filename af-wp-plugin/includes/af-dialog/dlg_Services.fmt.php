<?php
/*
 * dlg_Services.fmt script Copyright (c) 2005 Architected Futures, LLC
 *
...
$myProcClass = 'C_AirServicesPanel';
$myDynamClass = $myProcClass;	
require(AF_AUTOMATED_SCRIPTS.'/af_script_header.php');

class C_AirServicesPanel extends C_HtmlPanel {
	/***************************************************************************
	 * Constructor
	 *
...
//		$this->setHiddenElement('dlgAuth',			$this->anchor->sessionDoc->getAuthId());
		...
		$myTitleData->initialize(htmlEleH1, null, 'Services');

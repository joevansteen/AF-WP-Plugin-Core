<?php
/*
 * af_useradmin script Copyright (c) 2005 Architected Futures, LLC
 *
...
//		$navSecondary[] = $navItem;
	...
	$anchor->dlgStepResponse->title = 'Administration';
	...
	$tab1col1_1		= & $tab1row1->createChild(htmlEleTblData);
							 $tab1col1_1->createChild(htmlEleH1, 'Administration');

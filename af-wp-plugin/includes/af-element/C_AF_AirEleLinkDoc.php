<?php
/*
 * C_AF_AirEleLinkDoc script Copyright (c) 2005, 2008 Architected Futures, LLC
 *
 * V1.8 2008-APR-06 JVS C_AF_AirEleLinkDoc refactored from af_element
 * V5   2019-APR-04 JVS EATSv5 required script include segment
 */

// Insure a correct execution context ...
$myProcClass = 'C_AF_AirEleLinkDoc';
...
require_once(AF_CORE_SCRIPTS.'/af_script_header.php');
	 ...
	 * C_AF_AirEleLinkDoc
	 *
	 * Defines an AIR Element Link Document. This is a concrete class (document
	 * type) used to implement linkage to external content within AIR models.
	 ***************************************************************************/

class C_AF_AirEleLinkDoc extends C_AF_AirEleContentDoc {
	...
	function __construct()
		...
		} // end of [Constructor] C_AirEleLinkDoc()

	/***************************************************************************
	 * initAirEleLinkDoc()
	 *
	 * Initializes a new AirEleLinkDoc from specifications supplied by the caller.
	 *******/
	function initAirEleLinkDoc($eleType, $eleName = NULL, $eleAuthor = NULL,
		...
		$this->putContentType(AIR_EleContent_Link);
		}	// End of function initAirEleLinkDoc()
	...
	function getLinkType()
		{
		return($this->getElementData('LinkType'));
		} // end of getLinkType()

	/***************************************************************************
	 * putLinkType()
	 *******/
	function putLinkType($newContent)
		{
		return($this->putElementData('LinkType', $newContent));
		} // end of putLinkType()

	/***************************************************************************
	 * getLinkContentType()
	 *******/
	function getLinkContentType()
		{
		return($this->getElementData('LinkContentType'));
		} // end of getLinkContentType()

	/***************************************************************************
	 * putLinkContentType()
	 *******/
	function putLinkContentType($newContent)
		{
		return($this->putElementData('LinkContentType', $newContent));
		} // end of putLinkContentType()

	} // End of class C_AF_AirEleLinkDoc
